...
```bash
sam-app-image$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
sam-app-image$ sam logs -n HelloWorldFunction --stack-name sam-app-image --tail
```
